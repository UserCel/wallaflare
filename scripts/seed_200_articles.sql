...
INSERT INTO entries (id, url, title, content, domain_name, reading_time, language, is_archived, is_starred, created_at, updated_at, author, revision) VALUES (9, 'https://idodos.org/article-9-building-zero-cost-distributed', 'Building Zero-Cost Distributed Read-It-Later Services', '<p>Welcome to <strong>Building Zero-Cost Distributed Read-It-Later Services</strong>. This article was published by <em>Rich Hickey</em> on <a href="https://idodos.org/article-9-building-zero-cost-distributed">idodos.org</a>.</p>
<h2>Overview & Key Insights</h2>
<p>Modern distributed systems require robust local caching, monotonic revision tracking, and zero-latency UI responses. When reading long articles on desktop or mobile e-readers, readers expect effortless instant search, distraction-free typography, and instant offline availability.</p>
<blockquote>Simplicity is prerequisite for reliability. Software engineering should prioritize minimal footprint and robust local storage.</blockquote>
<h3>Detailed Breakdown</h3>
...
<p>In conclusion, serverless SQLite edge compute paired with monotonic revisions provides the ideal architecture for read-it-later systems.</p>', 'idodos.org', 7, 'en', 1, 0, '2026-08-02T15:00:00Z', '2026-08-02T15:00:00Z', 'Rich Hickey', 9);
INSERT INTO entries (id, url, title, content, domain_name, reading_time, language, is_archived, is_starred, created_at, updated_at, author, revision) VALUES (10, 'https://idodos.org/article-10-building-zero-cost-distributed', 'Building Zero-Cost Distributed Read-It-Later Services (Part 2)', '<p>Welcome to <strong>Building Zero-Cost Distributed Read-It-Later Services (Part 2)</strong>. This article was published by <em>Kelsey Hightower</em> on <a href="https://idodos.org/article-10-building-zero-cost-distributed">idodos.org</a>.</p>
<h2>Overview & Key Insights</h2>
<p>Modern distributed systems require robust local caching, monotonic revision tracking, and zero-latency UI responses. When reading long articles on desktop or mobile e-readers, readers expect effortless instant search, distraction-free typography, and instant offline availability.</p>
<blockquote>Simplicity is prerequisite for reliability. Software engineering should prioritize minimal footprint and robust local storage.</blockquote>
<h3>Detailed Breakdown</h3>
...
<p>In conclusion, serverless SQLite edge compute paired with monotonic revisions provides the ideal architecture for read-it-later systems.</p>', 'idodos.org', 9, 'en', 0, 1, '2026-08-02T18:00:00Z', '2026-08-02T18:00:00Z', 'Kelsey Hightower', 10);
INSERT INTO entries (id, url, title, content, domain_name, reading_time, language, is_archived, is_starred, created_at, updated_at, author, revision) VALUES (11, 'https://idodos.org/article-11-building-zero-cost-distributed', 'Building Zero-Cost Distributed Read-It-Later Services (Part 3)', '<p>Welcome to <strong>Building Zero-Cost Distributed Read-It-Later Services (Part 3)</strong>. This article was published by <em>Kelsey Hightower</em> on <a href="https://idodos.org/article-11-building-zero-cost-distributed">idodos.org</a>.</p>
<h2>Overview & Key Insights</h2>
<p>Modern distributed systems require robust local caching, monotonic revision tracking, and zero-latency UI responses. When reading long articles on desktop or mobile e-readers, readers expect effortless instant search, distraction-free typography, and instant offline availability.</p>
<blockquote>Simplicity is prerequisite for reliability. Software engineering should prioritize minimal footprint and robust local storage.</blockquote>
<h3>Detailed Breakdown</h3>
...
<p>In conclusion, serverless SQLite edge compute paired with monotonic revisions provides the ideal architecture for read-it-later systems.</p>', 'idodos.org', 11, 'en', 0, 0, '2026-08-02T21:00:00Z', '2026-08-02T21:00:00Z', 'Kelsey Hightower', 11);
INSERT INTO entries (id, url, title, content, domain_name, reading_time, language, is_archived, is_starred, created_at, updated_at, author, revision) VALUES (12, 'https://idodos.org/article-12-building-zero-cost-distributed', 'Building Zero-Cost Distributed Read-It-Later Services (Part 4)', '<p>Welcome to <strong>Building Zero-Cost Distributed Read-It-Later Services (Part 4)</strong>. This article was published by <em>Kelsey Hightower</em> on <a href="https://idodos.org/article-12-building-zero-cost-distributed">idodos.org</a>.</p>
<h2>Overview & Key Insights</h2>
<p>Modern distributed systems require robust local caching, monotonic revision tracking, and zero-latency UI responses. When reading long articles on desktop or mobile e-readers, readers expect effortless instant search, distraction-free typography, and instant offline availability.</p>
<blockquote>Simplicity is prerequisite for reliability. Software engineering should prioritize minimal footprint and robust local storage.</blockquote>
<h3>Detailed Breakdown</h3>
...
<p>In conclusion, serverless SQLite edge compute paired with monotonic revisions provides the ideal architecture for read-it-later systems.</p>', 'idodos.org', 13, 'en', 1, 0, '2026-08-03T00:00:00Z', '2026-08-03T00:00:00Z', 'Kelsey Hightower', 12);
